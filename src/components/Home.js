    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>
                    This app is intended to be a starter/tuttorial app for upcoming project and a learning sandbox for you in months and years to come should you continue to develop software with React. In this application we will work through some of the basic React concepts, build out some small applications, and then unleash you to build your own applications.
                </p>
                <hr />
                ...
                <ul>
                    ...
                    <li>
                        The setup for this app might be the most confusing part. Hang in there..
                    </li>
                    <li>
